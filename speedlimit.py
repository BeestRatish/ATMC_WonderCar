...
while True:
    ...
    for (x, y, w, h) in stop_signs:
        ...
        # Calculate the distance based on the size of the stop sign in the image (in centimeters)
        ...
        estimated_distance_cm = (stop_sign_width * focal_length * 100) / stop_sign_width_px  # Distance in centimeters

        # Display the estimated distance on the frame
        cv2.putText(frame, f'Distance: {estimated_distance_cm:.2f} cm', (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                    (0, 255, 0), 2)
